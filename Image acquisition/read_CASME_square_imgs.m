function total_dir = read_CASME_square_imgs(data_dir,subject,video)
    gap1='';
...
%     [~,~,excel_table] = xlsread(file_name,4);
    ...
    if subject>22
        ...
        for k = 3:subfold_le
            if subfolder_list(k).isdir == 1
                ...
                Video_list(subfold_count) = find(strcmp(video_code,types_video));
